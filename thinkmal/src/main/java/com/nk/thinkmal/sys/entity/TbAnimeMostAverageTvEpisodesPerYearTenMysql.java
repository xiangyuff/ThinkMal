...
/**
 * <p>
 * 1960年至今每年TV动画的平均剧集数量最多的前十名
 * </p>
 *
 * @author baomidou
 * @since 2023-08-07
 */
@TableName("tb_anime_most_average_tv_episodes_per_year_ten_mysql")
public class TbAnimeMostAverageTvEpisodesPerYearTenMysql implements Serializable {
    ...
    public String toString() {
        return "TbAnimeMostAverageTvEpisodesPerYearTenMysql{" +
            "year=" + year +
